...
!if $(CAPSULE_ENABLE)
  ...
  # oh my god
  # #define IMAGE_TYPE_ID_GUID                  { 0x39DBB991, 0x9994, 0x48C8, { 0x9F, 0xDB, 0xDC, 0x32, 0xF3, 0x8B, 0x9E, 0xBC } }
  gEfiMdeModulePkgTokenSpaceGuid.PcdSystemFmpCapsuleImageTypeIdGuid|{0x91, 0xB9, 0xDB, 0x39, 0x94, 0x99, 0xC8, 0x48, 0x9F, 0xDB, 0xDC, 0x32, 0xF3, 0x8B, 0x9E, 0xBC}
  # FileGuid    = A17B6F49-8551-4B8D-A046-AF598EB0CAEA  # PcdEdkiiSystemFirmwareFileGuid
  gEfiSignedCapsulePkgTokenSpaceGuid.PcdEdkiiSystemFirmwareFileGuid|{0x49, 0x6F, 0x7B, 0xA1, 0x51, 0x85, 0x8D, 0x4B, 0xA0, 0x46, 0xAF, 0x59, 0x8E, 0xB0, 0xCA, 0xEA}
!endif